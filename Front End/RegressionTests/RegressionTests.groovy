...
def jobslist = [
  ...
  [
    jobTitle: 'ADS - IM Articles - Photo Gallery - Desktop - LG5-6180',
    COMPONENT: 'MT/Article/ADS/',
    TESTCASE: 'IMArticlesPhotoGallery',
    URLFILE: '',
    PAGESLUG: '',
    AMP: '',
    PAGETYPE: '',
  ...
  [
    jobTitle: 'SEO - Author Page - LG5-6753',
    COMPONENT: 'MT/Other/SEO/',
    TESTCASE: 'SEOAuthorPage',
    URLFILE: '',
    PAGESLUG: '',
    AMP: '',
    PAGETYPE: '',
  ...
  [
    jobTitle: 'SEO - Staff Page - LG5-6753',
    COMPONENT: 'MT/Other/SEO/',
    TESTCASE: 'SEOStaffPage',
    URLFILE: '',
    PAGESLUG: '',
    AMP: '',
    PAGETYPE: '',
  ...
  */
  ...
  [
    jobTitle: "mParticle - Price Page - PageView - LG5-6547",
    COMPONENT: "MT/BuyersGuide/ANALYTICS/mParticle", 
    TESTCASE: "mParticlePricePage", 
    URLFILE: "", 
    PAGESLUG: "",
    AMP: "", 
    PAGETYPE: "",
  ...
  [
    jobTitle: "mParticle - Car Match Landing - PageView - CSIN-586",
    COMPONENT: "MT/BuyersGuide/ANALYTICS/mParticle", 
    TESTCASE: "mParticleCarMatchLanding", 
    URLFILE: "", 
    PAGESLUG: "",
    AMP: "", 
    PAGETYPE: "",
      ...
      definition {
        cps {
          script('''
            ...
            catchError(buildResult: 'FAILURE', stageResult: 'FAILURE') {
                stage('mParticle - Car Match Landing - PageView - CSIN-586') {
                    build job: 'mParticle - Car Match Landing - PageView - CSIN-586', parameters: [string(name: 'SERVER', value: String.valueOf(SERVER)), string(name: 'BRANCH', value: String.valueOf(BRANCH))]
                }
            }
          '''
          )
      ...
      definition {
        cps {
          script('''
            ...
            catchError(buildResult: 'FAILURE', stageResult: 'FAILURE') {
                stage('mParticle - Price Page - PageView - LG5-6547') {
                    build job: 'mParticle - Price Page - PageView - LG5-6547', parameters: [string(name: 'SERVER', value: String.valueOf(SERVER)), string(name: 'BRANCH', value: String.valueOf(BRANCH))]
                }
            }
          '''
          )
      ...
      definition {
        cps {
          script('''
            ...
            catchError(buildResult: 'FAILURE', stageResult: 'FAILURE') {
                stage('SEO - Staff Page - LG5-6753') {
                    build job: 'SEO - Staff Page - LG5-6753', parameters: [string(name: 'SERVER', value: String.valueOf(SERVER)), string(name: 'BRANCH', value: String.valueOf(BRANCH))]
                }
            }
          '''
          )
      ...
      definition {
        cps {
          script('''
            ...
            catchError(buildResult: 'FAILURE', stageResult: 'FAILURE') {
                stage('SEO - Author Page - LG5-6753') {
                    build job: 'SEO - Author Page - LG5-6753', parameters: [string(name: 'SERVER', value: String.valueOf(SERVER)), string(name: 'BRANCH', value: String.valueOf(BRANCH))]
                }
            }
          '''
          )
            ...
            catchError(buildResult: 'FAILURE', stageResult: 'FAILURE') {
                stage('UIUX - Homepage - Email Sign Up Right Column - LG5-841') {
                    build job: 'UIUX - Homepage - Email Sign Up Right Column - LG5-841', parameters: [string(name: 'SERVER', value: String.valueOf(SERVER)), string(name: 'BRANCH', value: String.valueOf(BRANCH))]
                        ...
                        catchError(buildResult: 'FAILURE', stageResult: 'FAILURE') {
                stage('ADS - IM Articles - Photo Gallery - Desktop - LG5-6180') {
                    build job: 'ADS - IM Articles - Photo Gallery - Desktop - LG5-6180', parameters: [string(name: 'SERVER', value: String.valueOf(SERVER)), string(name: 'BRANCH', value: String.valueOf(BRANCH))]
                }
            }
          '''
          )
          ...
          script('''
            ...
            catchError(buildResult: 'FAILURE', stageResult: 'FAILURE') {
                stage('FE - '''+"${CWVFolders[index]}"+''' 0 Job') {
                    build job: '/QA-Selenium/ONO/Core Web Vitals/'''+"${CWVFolders[index]}"+'''/Desktop/0 - Run all CWV tests - Desktop', parameters: [string(name: 'SERVER', value: String.valueOf(SERVER)), string(name: 'BRANCH', value: String.valueOf(BRANCH))]
                }
            }
          '''
          )
